...
class UserCreationForm(forms.ModelForm):
    username = forms.CharField(label=_('Username'), max_length=30,help_text=_(
        "Username should not contain spaces"),
         widget=forms.TextInput(attrs={
             'class': 'form-control form-control-sm input-size bg-secondary',
    ...
    username = forms.CharField(label=_('Username'), max_length=30,help_text=_("Username should not contain spaces"), widget=forms.TextInput(
        attrs={'class': 'form-control form-control-sm input-size', 'placeholder': _('Username')}))
    email = forms.EmailField(label=_('Email'), widget=forms.EmailInput(
        attrs={'class': 'form-control form-control-sm', 'placeholder': _('Email')}))
    first_name = forms.CharField(label=_('First name'), widget=forms.TextInput(
        attrs={'class': 'form-control form-control-sm input-size', 'placeholder': _('First name')}))
    last_name = forms.CharField(label=_('Last name'),widget=forms.TextInput(
        attrs={'class': 'form-control form-control-sm input-size ', 'placeholder': _('Last name')}))
    password1 = forms.CharField(label=_('Password'), widget=forms.PasswordInput(
        attrs={'class': 'form-control form-control-sm input-size', 'placeholder': _('Password')}), min_length=8)
    password2 = forms.CharField(label=_('Confirm Password'), widget=forms.PasswordInput(
        attrs={'class': 'form-control form-control-sm input-size', 'placeholder': _('Confirm Password')}), min_length=8)
...
class UpdateProfile(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            'gander': forms.Select(attrs={'class': 'form-control form-control-sm input-update'} ),
            'country': forms.Select(attrs={'class': 'form-control form-control-sm input-update'} ),
        }
